        ...
        <Box className={classes.carousel}>
          ...
          >
            ...
            <div className={classes.carouselItem}>
              ...
              <Typography variant="body2">Mereka yang mengira kamu sering menggombaliku setiap hari, tidak pernah tahu bahwa caramu bicara kepadaku lebih sering tanpa tata bahasa yang sempurna. Misalnya, “Yang, jam tangan,” itu artinya kamu bertanya di mana jam tanganmu. Atau “Yang, aku budrek,” itu artinya kamu mau minta waktu me time dengan bermain PS4 tanpa diganggu.</Typography>
            </div>
            <div className={classes.carouselItem}>
